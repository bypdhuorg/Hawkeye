...
EXPOSE 80
RUN apt-get update --registry-mirror=https://registry.docker-cn.com
RUN apt-get install --registry-mirror=https://registry.docker-cn.com --no-install-recommends -y curl gnupg git redis-server supervisor software-properties-common wget
...
RUN apt-get update --registry-mirror=https://registry.docker-cn.com
RUN apt-get install --registry-mirror=https://registry.docker-cn.com -y openresty
