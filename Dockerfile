...
RUN apt-get update && apt-get install -y python3-gi python3-dbus python3-software-properties
RUN apt-get update && apt-get install -f --no-install-recommends -y curl gnupg git redis-server supervisor software-properties-common wget
